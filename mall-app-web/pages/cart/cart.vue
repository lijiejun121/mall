				...
				<block v-for="(item, index) in cartList" :key="item.id">
					<view class="cart-item" :class="{'b-b': index!==cartList.length-1}">
						...
						<view class="item-right">
							...
							<uni-number-box class="step" :min="1" :max="100" :value="item.quality" :index="index" @eventChange="numberChange"></uni-number-box>
						</view>
					</view>
				</block>
			</view>
	...
	export default {
		...
		methods: {
			...
			numberChange(data) {
				...
				updateQuantity({id: cartItem.id, quantity:dat.number}).then(response => {
...
<style lang='scss'>
	...
	.action-section {
		...
		box_shadow: 0 0 20upx 0 rgba(0, 0, 0, .5);
		border-radius: 16upx;
